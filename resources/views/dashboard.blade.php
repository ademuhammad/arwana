                    ...
                    <div class="col-md-4">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number" id="kualitasAir">{{ $data->first()->fuzzy }}</span>
                    ...
                    <div class="col-md-4">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number" id="phAir">{{ $data->first()->final_ph }}</span>
                    ...
                    <div class="col-md-4">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number" id="kekeruhan">{{ $data->first()->final_ker }}</span>
